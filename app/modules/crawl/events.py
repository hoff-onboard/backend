...
def agent_thought_event(step: int, thought: str, flow_index: int | None = None) -> dict[str, Any]:
...
def screenshot_event(step: int, data_b64: str, flow_index: int | None = None) -> dict[str, Any]:
